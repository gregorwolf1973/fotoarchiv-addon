...
- **Rechtsklick** (am Handy lange drücken) auf ein Foto oder eine Gruppe öffnet ein Menü, alles mit „Rückgängig“:
  - *Ort ändern …* (einzelnes Foto): neuer Ort über den Ortsdialog mit Suche und Stecknadel.
  - *Gruppe verschieben …*: Die Stecknadel steht in der Mitte der Gruppe; wohin du sie setzt, dorthin wandern alle Fotos um denselben Versatz, ihre Anordnung zueinander bleibt. Richtig, wenn die Kamera den Ort insgesamt falsch hatte.
  - *Alle auf einen Punkt …*: Alle Fotos der Gruppe bekommen genau den gewählten Ort.
  - *Ort entfernen*: zurück ins Fenster „Ohne Ort“. *Ansehen*: die Gruppe in der Einzelansicht.
