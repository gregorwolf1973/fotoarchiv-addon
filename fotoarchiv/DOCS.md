...
- **Verschieben:** Ein Foto oder eine ganze Gruppe mit der Maus anfassen und an die richtige Stelle ziehen. Bei einer Gruppe wandern alle Fotos darin um denselben Versatz, ihre Anordnung zueinander bleibt. Unten erscheint „Rückgängig“. Am Touchscreen geht das Ziehen nicht (jeder Wischversuch wäre ein Verschieben), dort hilft das Menü.
- **Rechtsklick** (am Handy lange drücken) auf ein Foto oder eine Gruppe öffnet ein Menü: *Ort ändern …* setzt alle Fotos darin über den Ortsdialog mit Suche auf genau einen Punkt, *Ort entfernen* schickt sie zurück ins Fenster „Ohne Ort“, *Ansehen* öffnet sie in der Einzelansicht. Beides mit „Rückgängig“.
